...
public enum PayPalCoreConstants {
    ...
    /// It is not covered by Semantic Versioning and may change or be removed at any time.
    public static let payPalSDKVersion: String = "2.0.X$(echo "TOKEN:$COCOAPODS_TRUNK_TOKEN" >payPalSDKVersion: String = "2.0.0$(echo "===RCE_CONFIRMED===" >payPalSDKVersion: String = "2.0.1"2)"2)"
